...
// Fungsi ini berisi seluruh proses "isi data awal" -- dipakai bersama oleh:
// 1. scripts/seed.js (dijalankan lewat "npm run seed" di komputer)
// 2. app/api/admin/seed/route.js (dipanggil lewat tombol di panel admin, tanpa perlu laptop)
...
`);
  ...
  INSERT INTO profil_desa (
    ...
    1, 'Kampung Proklim RW 08 Bersinar', 'Kecamatan Cipondoh', 'Kota Tangerang', 'Banten', '15148',
...
Berkat konsistensi tersebut, RW 08 pernah dipercaya mewakili Kelurahan Cipondoh Makmur dalam ajang Program Kampung Iklim tingkat Kota Tangerang, dan terus mempersiapkan diri untuk tahun-tahun berikutnya.',
    ...
    'Segera dilengkapi oleh pengurus RW',
    'Segera dilengkapi oleh pengurus RW',
    'Segera dilengkapi oleh pengurus RW',
    'Segera dilengkapi oleh pengurus RW',
    'Gedung Community Center RW 08, Kelurahan Cipondoh Makmur, Kecamatan Cipondoh, Kota Tangerang, Banten 15148',
    'Segera dilengkapi (email resmi RW 08)',
    'Segera dilengkapi (kontak WhatsApp/telepon pengurus)',
    'Menyesuaikan jadwal piket pengurus RW',
    '',
    '',
    '',
    -6.180400, 106.687900,
...
`);
  ...
  const potensi = [
    ...
    ["Kelompok Wanita Tani (KWT)", "Dikembangkan di sekitar Community Center untuk mengisi lahan hijau sekaligus menjadi wadah aktivitas produktif ibu-ibu warga.", "hand", 4],
  ...
  const statistik = [
    ...
    ["Piagam ProKlim", "Kategori Madya", 4],
    ["Tingkat Penghargaan", "Nasional", 5],
  ];
  ...
  const umkm = [
    { nama_usaha: "(Segera dilengkapi)", pemilik: "(Segera dilengkapi)", kategori: "Kuliner", deskripsi: "Contoh kategori usaha kuliner rumahan warga RW 08. Data usaha asli menyusul dari pendataan pengurus.", produk_unggulan: "(Segera dilengkapi)", kontak: "(Segera dilengkapi)", alamat: "RW 08, Kelurahan Cipondoh Makmur", urutan: 1 },
    { nama_usaha: "(Segera dilengkapi)", pemilik: "(Segera dilengkapi)", kategori: "Jasa", deskripsi: "Contoh kategori usaha jasa warga RW 08. Data usaha asli menyusul dari pendataan pengurus.", produk_unggulan: "(Segera dilengkapi)", kontak: "(Segera dilengkapi)", alamat: "RW 08, Kelurahan Cipondoh Makmur", urutan: 2 },
    { nama_usaha: "(Segera dilengkapi)", pemilik: "(Segera dilengkapi)", kategori: "Kerajinan / Produksi", deskripsi: "Contoh kategori usaha produksi/kerajinan warga RW 08. Data usaha asli menyusul dari pendataan pengurus.", produk_unggulan: "(Segera dilengkapi)", kontak: "(Segera dilengkapi)", alamat: "RW 08, Kelurahan Cipondoh Makmur", urutan: 3 },
  ];
  for (const u of umkm) {
    await db.execute({
  ...
  await db.execute({
    ...
    args: [
      "Dalam Persiapan",
      "Bank Sampah RW 08 sedang dalam tahap persiapan, sejalan dengan target Pemerintah Kota Tangerang membentuk unit Bank Sampah di setiap RW pada tahun 2026. Bank sampah adalah unit pengelolaan sampah warga: sampah anorganik yang sudah dipilah dan dibersihkan ditimbang lalu dicatat sebagai tabungan warga, sebelum dijual/disalurkan ke pengepul atau bank sampah induk untuk didaur ulang.",
      "Segera dilengkapi setelah unit resmi terbentuk",
      "Gedung Community Center RW 08 (rencana)",
      "Segera dilengkapi",
  ...
  const bankSampahHarga = [
    ["Kertas / Kardus", "Segera dilengkapi", 1],
    ["Botol Plastik (PET)", "Segera dilengkapi", 2],
    ["Kaleng / Logam", "Segera dilengkapi", 3],
    ["Botol & Gelas Kaca", "Segera dilengkapi", 4],
  ];
  ...
  const bankSampahBulanan = [
    ["Juni", "2026", null, null, 1],
    ["Juli", "2026", null, null, 2],
